...
/**
 * This is a convenience for specifying {@link FunctionalityInterface#traitPredicate()} :>
 ...
 * 		+ The declaring class or interface must be annotated with {@link FunctionalityInterface}
 * 			+ And it must have {@link FunctionalityInterface#traitPredicate()} and {@link FunctionalityInterface#equivalentBehavior()} set to the empty string ""  (which is the default :> )
 * 
