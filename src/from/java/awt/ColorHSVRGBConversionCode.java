package from.java.awt;

/**
 * Copied straight from java.awt.Color, with minor modifications :>
 */
public class ColorHSVRGBConversionCode
{
	/**
	 ...
	 * by the method Color.getRGB(). This integer can be supplied as
	...
	{
		return packRGB(HSVtoRGBUnpacked(hue, saturation, brightness));
	}
	...
	public static int[] HSVtoRGBUnpacked(float hue, float saturation, float brightness)
	{
		int r = 0, g = 0, b = 0;
		if (saturation == 0)
		{
